...
This repository contains a curated collection of **bank logos in SVG format** from **India and international markets**. All logos are optimized for web use, scalable, and maintained in high quality. Ideal for:

- **Financial applications** and fintech platforms
- **Banking software** and mobile apps
- **Payment gateways** and e-commerce websites
- **Educational projects** and research
- **Web developers** and UI/UX designers

## ✨ Features

- ✅ **100+ Bank Logos** - Indian and International
- ✅ **SVG Format** - Scalable, lightweight, and crisp
- ✅ **Optimized** - Web-ready and production-grade
- ✅ **Free to Use** - MIT License
- ✅ **Regularly Updated** - New banks added frequently
- ✅ **Organized Structure** - Easy to navigate and integrate
- ✅ **SEO Optimized** - Easy to discover and search
...
To add a new bank logo:
1. Fork the repository
2. Add the SVG file to the appropriate folder (`indian-bank` or `international-bank`)
3. Update this README with the bank information
...
`bank logos`, `indian bank logos`, `international bank logos`, `bank icons`, `bank symbols`, `svg bank logos`, `financial logos`, `banking logos`, `hdfc logo`, `sbi logo`, `icici logo`, `axis bank logo`, `kotak bank logo`, `bank of america logo`, `chase bank logo`, `citibank logo`, `hsbc logo`, `barclays logo`, `wells fargo logo`, `payment bank logos`, `fintech logos`, `bank branding`, `financial institution logos`, `bank vector logos`, `scalable bank logos`, `bank logo svg`, `open source bank logos`, `free bank logos`, `bank logo collection`, `bank logo repository`, `bank logo api`, `bank logo database`, `indian banks`, `international banks`, `global bank logos`, `world bank logos`, `commercial bank logos`, `private bank logos`, `public sector bank logos`, `small finance bank logos`, `payment bank logos`, `digital bank logos`, `neobank logos`

## 📊 Statistics

- **Total Banks**: 100+
- **Indian Banks**: 42+
- **International Banks**: 50+
...
- [Bank APIs](https://github.com/topics/banking-api)
- [Fintech Resources](https://github.com/topics/fintech)
- [Payment Gateway Integration](https://github.com/topics/payment-gateway)
